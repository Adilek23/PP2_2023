...
pygame.display.set_caption('Snake Adil')
...
class Apple(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.Food_position_generate()
    def Food_position_generate(self):
...
while True:
    ...
    TIME += 0.5
    if TIME % 20 == 0:
        apple.Food_position_generate()
        #apple2.Food_position_generate()
        TIME = 0
