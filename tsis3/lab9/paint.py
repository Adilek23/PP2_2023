...
def drawRhombus(surface, color, x, y, x1, y1, size):
    rhombus_width = abs(x - x1)
    rhombus_height = abs(y - y1)
    rhombus_center = ((x + x1) // 2, (y + y1) // 2)

    pg.draw.polygon(surface, color, [(rhombus_center[0], rhombus_center[1]-rhombus_height//2),
                                               (rhombus_center[0]+rhombus_width//2, rhombus_center[1]),
                                               (rhombus_center[0], rhombus_center[1]+rhombus_height//2),
                                               (rhombus_center[0]-rhombus_width//2, rhombus_center[1])],
                                               size)
...
triangle = Button(5, 205, 'triangle.jpg')
right_triangle = Button(55, 205, 'right_triangle.png')
